...
console.log('1', typeof('cupcake') === ...);
console.log('2', typeof(123456789) === ...);
console.log('3', typeof(123 + 231) === ...);
console.log('4', typeof('1234567') === ...);
console.log('5', typeof(true)      === ...);
console.log('6', typeof(false)     === ...);
console.log('7', typeof(undefined) === ...);
console.log('8', typeof(1/0)       === ...);
console.log('9', typeof(1 / 'waffles')     === ...);

/* For the following, replace ...
 * with the value that you believe the left-hand side
 * will evaluate to.
 */
console.log('10', 4 + 123    === ...);
console.log('11', 4 + '123'  === ...);
console.log('12', 4 - "1"    === ...);
