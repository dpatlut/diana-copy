/* Instructions: Fix all the bugs (syntax, logical, and semantic).
 * All of the functions should run properly.
 * That means that I must be able to RUN and USE them
 * without any errors.
 * Write mulitple self-documenting console.log statements to test each function.
 * Include tests that verify the full intended functionality of the code.
 */
...
var fizzPop = function fizzPop(arr) {
  var resultsArray = [];//a collection of 'fizz', 'pop', or 'fizzPop'

  for (var i = 0; i < array.length; i++) {
    var number = array{i}; //a collection of numbers
